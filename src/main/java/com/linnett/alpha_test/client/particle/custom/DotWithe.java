...
public class DotWithe extends TextureSheetParticle {
    ...
    protected DotWithe(ClientLevel level, double x, double y, double z, float red, float green, float blue) {
        super(level, x, y, z);
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType type, ClientLevel level, double x, double y, double z, double dx, double dy, double dz) {
            ...
            DotWithe particle = new DotWithe(level, x, y, z, red, green, blue);
